...
// -------------------------------------------------------------------------
/**
 * This is the main executing class
 * 
...
public class Memman {
	...
	// ----------------------------------------------------------
	/**
	 * This is the main method that gets executed when this class gets called in
	 * a java execution environment.
	 * 
	 * @param args
	 *            arguments to be passed along as an array of strings.
	 */
